	  ...
	  if (_twoPlayers)
	    {
	      ...
	      >>>>>>> 5a3a8be34cd1607b84066a26308ec1a9ad3ebae4
...
bool				Gamer::handleKeyToP2Up(const float elapsedTime, gdl::Input&)
{
  Player*			player;
...
bool				Gamer::handleKeyToP2Down(const float elapsedTime, gdl::Input&)
{
  Player*			player;
